...
//                               PathController pathRepository, TaskCompletionService taskCompletionService,
...
//				.module(new SCModuleId(db.getModuleProofTechniques().getId()))
//				.skill(new SkillId(db.getSkillAssumption().getId()))
