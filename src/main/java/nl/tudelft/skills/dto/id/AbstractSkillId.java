...
public class AbstractSkillId extends IdDTO<AbstractSkill, Long> {
	...
	@Override
	public Class<? extends CrudRepository<AbstractSkill, Long>> repositoryClass() {
		return AbstractSkillRepository.class;
	}

	@Override
	public Class<? extends AbstractSkill> targetClass() {
